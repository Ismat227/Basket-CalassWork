window.onload = function () {
    const iconShopping = document.querySelector('.navbar-brand');
    ...
    const attCartButton = document.getElementsByClassName('badge');
    let items = [];
    for (let i = 0; i < attCartButton.length; i++) {
        attCartButton[i].addEventListener("click", function (e) {
